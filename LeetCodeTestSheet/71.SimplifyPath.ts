...
function simplifyPath(path: string): string {
  //  so it looks like am removing all / at the end
  //  removing all // and replacing it with single /
  //  removing all Documents/../ to just word/word
  //  removing all ../ from /../ to equal /
